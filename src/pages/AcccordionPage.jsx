...
const AcccordionPage = () => {
  return (
    <>
      <div className="border w-72 bg-white drop-shadow-xl hover:drop-shadow-2xl border-sky-500 rounded-2xl mx-3  h-full p-6">
        <div className="font-extrabold text-fuchsia-950 hover:text-pink-700 text-4xl text-left">
          <div className="flex items-center">
            ...
            <div className="font-work-sans "></div>FAQs
          </div>
        </div>
        <Accordion />
      </div>
